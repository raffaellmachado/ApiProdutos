...
//        Assertions.assertEquals("Fisica", result.getRetorno().getContatos().get(0).getContato().getTipo());
...
//        Assertions.assertEquals("Fisica", result.getRetorno().getContatos().get(1).getContato().getTipo());
    ...
    void testGetContactsById() throws Exception {
        ...
        Assertions.assertEquals(1, result.getRetorno().getContatos().size());
        Assertions.assertEquals("01", result.getRetorno().getContatos().get(0).getContato().getId());
        Assertions.assertEquals("Nome do contato", result.getRetorno().getContatos().get(0).getContato().getNome());
        Assertions.assertEquals("Contato Corp", result.getRetorno().getContatos().get(0).getContato().getFantasia());
...
//        Assertions.assertEquals("01", result.getRetorno().getContatos().getContato().getId());
//        Assertions.assertEquals("Nome do contato", result.getRetorno().getContatos().getContato().getNome());
//        Assertions.assertEquals("Contato Corp", result.getRetorno().getContatos().getContato().getFantasia());
////        Assertions.assertEquals("F", result.getRetorno().getContatos().getContato().getTipo());
//        Assertions.assertEquals("02", result.getRetorno().getContatos().getContato().getContribuinte());
//        Assertions.assertEquals("11.111.111/1111-11", result.getRetorno().getContatos().getContato().getCpf_cnpj());
//        Assertions.assertEquals("146849932111", result.getRetorno().getContatos().getContato().getIe_rg());
//        Assertions.assertEquals("Rua João Moura Teste", result.getRetorno().getContatos().getContato().getEndereco());
//        Assertions.assertEquals("1251", result.getRetorno().getContatos().getContato().getNumero());
//        Assertions.assertEquals("null", result.getRetorno().getContatos().getContato().getComplemento());
//        Assertions.assertEquals("Pinheiros", result.getRetorno().getContatos().getContato().getBairro());
//        Assertions.assertEquals("05.412-001", result.getRetorno().getContatos().getContato().getCep());
//        Assertions.assertEquals("São Paulo", result.getRetorno().getContatos().getContato().getCidade());
//        Assertions.assertEquals("SP", result.getRetorno().getContatos().getContato().getUf());
//        Assertions.assertEquals("(11) 999999999", result.getRetorno().getContatos().getContato().getFone());
//        Assertions.assertEquals("contato@teste.com", result.getRetorno().getContatos().getContato().getEmail());
//        Assertions.assertEquals("0.00", result.getRetorno().getContatos().getContato().getLimiteCredito());
//
